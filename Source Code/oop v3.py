...
class GuiClass():                                    # class for the main window of the program
    def __init__(self):
        ...
        self.canvas.create_image(450, 50, anchor=tk.NW, image=self.img)
...
#####################################################################Image######################
    def detect_image(self):
        ...
        self.file1 = filedialog.askopenfilename(initialdir = os.getcwd(), title='Choose an image...',
                                                filetypes = (('PNG File','*.png'),('JPG File',"*.jpg"),('jpeg files', '*.jpeg'),('jfif files', '*.jfif')))
        if self.file1 == '':
            return 0
...
####################################################################Video####################
    def detect_video(self):
        ...
        out_video = cv2.VideoWriter('Resources/detections/videos/result' + str(self.video_res_count) + '.mp4',
                                    cv2.VideoWriter_fourcc(*'mp4v'), 20.0, (self.width, self.height))
